  ...
  return (
    <React.Fragment>
      ...
      >
        <ProductWithImage
          pathColor="#9faa7f"
          background={`${pathBackend}/wp-content/uploads/2021/08/Vino_Gamo.png`}
          title="GAMO"
          text=" 
          ...
          position="left"
          pdf={`${pathBackend}/wp-content/uploads/2021/10/Schede-tecniche_GAMO-18-19-20.pdf"`}
        />

        <ProductWithImage
          pathColor="#c9593d"
          background={`${pathBackend}/wp-content/uploads/2021/08/Vino_Drankante.png`}
          title="DRAKANTE"
          ...
          position="right"
          pdf={`${pathBackend}/wp-content/uploads/2021/11/Schede-tecniche_DRANKANTE-19-20.pdf`}
        />

        <ProductWithImage
          pathColor="#eb8c2c"
          background={`${pathBackend}/wp-content/uploads/2021/08/Vino_Vignesperse.png`}
          title="VIGNESPERSE"
          ...
          position="left"
          pdf={`${pathBackend}/wp-content/uploads/2021/11/Scheda-tecnica_VIGNESPERSE-20.pdf`}
        />

        <ProductWithImage
          pathColor="#c6b67b"
          background={`${pathBackend}/wp-content/uploads/2021/08/Vino_Maestà-della-Formica.png`}
          ...
          position="right"
          pdf={`${pathBackend}/wp-content/uploads/2021/12/Scheda-tecnica_RIESLING-19-20.pdf`}
        />
      </section>
    </React.Fragment>
  )
